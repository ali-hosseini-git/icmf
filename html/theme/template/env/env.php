...
// 		echo 1;
		...
		$sections ['newsTicker'] = true;
		$sections ['left'] = true;
		$sections ['leftWidth'] = 30;
		$settings ['testimonials'] = false;
		$sections ['footer'] = true;
		$sections ['googleMap'] = false;
		break;
	case 'contact' :
// 		echo 2;
		...
		$sections ['slider'] = true;
		$sections ['newsTicker'] = true;
		$sections ['left'] = false;
		$settings ['testimonials'] = true;
		$sections ['footer'] = true;
		break;
	case 'pageLoader' :
// 		echo 3;
		switch ($sysVar ['filter']) {
			case 'forms' :
// 				echo 4;
				// Form landing page
				$sections ['basket'] = false;
...
$system->xorg->smarty->assign ( "postCategory", $system->xorg->htmlElements->treeElement->tree ( $settings [postCategory], $settings ['baseCategory'], 'postCategory', "postCategory right specialFont", "`id` IN ($settings[categoryList]) AND `active` = 1" ) );
