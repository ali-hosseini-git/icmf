...
switch ($sysVar['op']){
	case 'post': //blog
		...
		$sections['rightWidth'] = 2; 
		$sections['center'] = true;
		$sections['centerWidth'] = 8;
		$sections['slider'] = false; 
		$sections['left'] = true;
		$sections['leftWidth'] = 2;
...
$system->xorg->smarty->assign("jsonList", m_post::m_jsonList($_GET['filter']));
