...
$('#orderButton').live('click', function(){
	switch ($(this).attr('rel')){
		case 'boronzi':
			$('#orderForm').farajax('loader', '/humanResource/v_addObject/boronzi');
			break;
		case 'silver':
			$('#orderForm').farajax('loader', '/humanResource/v_addObject/silver');
			break;
		case 'golden':
			$('#orderForm').farajax('loader', '/humanResource/v_addObject/golden');
			break;
		case 'almasi':
			$('#orderForm').farajax('loader', '/humanResource/v_addObject/almasi');
			break;
		case 'shop':
			$('#orderForm').farajax('loader', '/humanResource/v_addObject/shop');
			break;
...
$('#tPlans').live('click',function(){
	$('#tabContent1').farajax('loader', 'pageLoader/v_load/پلن-های-طراحی-سایت');
	$('.subTab1').removeClass('subTabClick');
	$(this).addClass('subTabClick');
});
...
//	$(this).addClass('subTabClick');
//});
$('#popupDemo').click(function(event) {
    event.preventDefault();
    window.open($(this).attr("rel"), "نمایش این قالب", "width=1280,height=768,scrollbars=yes");
});