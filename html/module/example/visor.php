<?php
Define("exampleConfFile", "$settings[moduleAddress]/$sysVar[op]/config/config");
$config = exampleConfFile . ".php";
...
if(file_exists($config)){
	...
	die("Example sub system is down !");
}
?>